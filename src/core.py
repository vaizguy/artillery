    ...
    if is_posix():
        if os.path.isdir("/var/artillery/.svn"):
            ...
            try:
                ...
                subprocess.Popen("git clone https://github.com/vaizguy/artillery", shell=True).wait()
            except:
                print "[!] Something failed. Please type 'git clone https://github.com/vaizguy/artillery /var/artillery' to fix!"
